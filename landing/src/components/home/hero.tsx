            ...
            >
              ...
              <Box sx={{ mb: 4, width: { xs: '100%', md: '70%' } }}>
                <Typography sx={{ color: 'text.secondary', lineHeight: 1.6 }}>
                  {
                    "Research nearby markets and try to apply for tender in the region."
                  }
                </Typography>
              </Box>
              <Box sx={{ '& button': { mr: 2 } }}>
                <ScrollLink to="popular-course" spy={true} smooth={true} offset={0} duration={350}>
                <a href="http://localhost/3000"> <StyledButton color="primary" size="large" variant="contained">
                    Get Started
                  </StyledButton> </a>
                </ScrollLink>
          ...
          <Grid item xs={12} md={5} sx={{ position: 'relative' }}>
            ...
            >
              ...
              <Box>
                <Typography
                  component="h6"
                  sx={{ color: 'text.primary', fontSize: '1.1rem', fontWeight: 700, mb: 0.5 }}
                >
                  Contract
                </Typography>
                <Typography variant="subtitle1" sx={{ color: 'text.secondary', lineHeight: 1.3 }}>
                  Great opportunity to sign contract.
                </Typography>
              </Box>
            </Box> */}
            <Box sx={{ lineHeight: 0  }}>
