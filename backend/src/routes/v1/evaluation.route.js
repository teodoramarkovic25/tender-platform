...
router
  ...
  .patch(auth('manageEvaluation'), validate(evaluationValidation.updateEvaluation), evaluationController.updateEvaluation)
  .delete(auth('manageEvaluation'), validate(evaluationValidation.deleteEvaluation), evaluationController.deleteEvaluation);
